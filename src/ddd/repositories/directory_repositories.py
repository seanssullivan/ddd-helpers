...
__all__ = ["DirectoryBasedRepository"]
...
class AbstractDirectoryBasedRepository(AbstractRepository):
    """Represents an abstract directory-based repository."""
...
class DirectoryBasedRepository(AbstractRepository):
    """Implements a directory-based repository.

    This repository reads data from multiple files in a directory.
